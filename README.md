...
## モジュール 8: カスタマイズしてみよう
一旦ここまででハンズオンは終了です。  
今回作成したアプリケーションは画像に対して Gemini でなにかやるという枠組みになっています。プログラム内部の「# ★★★ プロンプトを自由に調整 ★★★」この部分を修正することでいろいろなことができます。  

いまはバイクのメーカーと型を解析するようになってますが、いろいろ変更してデプロイしてみてください  
たとえば
* 車のメーカーを解析したり
* 写真から有名人の名前をだしてみたり
* たべものの写真をアップして料理のやりかたを教えてもらったり
